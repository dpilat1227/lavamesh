...
export function PageHeader({ title, subtitle, actions, stats }: PageHeaderProps) {
  return (
    <header className="page-header flex-shrink-0 px-5 sm:px-8 pt-6 pb-5">
      <div className="page-header-row flex items-center justify-between mb-5 gap-4">
        ...
        {actions && <div className="page-header-actions flex items-center gap-2 flex-shrink-0">{actions}</div>}
      </div>
      {stats}
    </header>
  );
