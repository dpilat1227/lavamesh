...
export default function Sidebar({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <aside className="w-[220px] flex flex-col min-h-screen border-r" style={{ borderColor: 'var(--border-1)', background: 'rgba(4,4,4,0.97)', backdropFilter: 'blur(40px)', flexShrink: 0 }}>
